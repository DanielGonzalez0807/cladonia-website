...
export function generateClientEmail(data) {
  const { nombre, apellido, destino, sendero, plan, fecha, visitantes, total, planDetails } = data;
          ...
          <tr>
            <td style="padding: 20px;">
              ...
              <table width="100%" cellpadding="8" cellspacing="0">
                ...
                <tr>
                  <td style="color: #6b7280; font-size: 14px;">Vehículos (${details.vehiculos})</td>
              ...
              <div style="margin-top: 15px; padding-top: 15px; border-top: 1px solid #e5e7eb;">
                <p style="color: #dc2626; margin: 0; font-size: 13px;">⚠️ <strong>Transporte NO incluido</strong> - Debes gestionar tu propio transporte</p>
              </div>
            </td>
          </tr>
        </table>
    ...
    <tr>
      <td style="padding: 0 30px 20px 30px;">
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f9fafb; border-radius: 8px; border: 1px solid #e5e7eb;">
          <tr>
            <td style="padding: 20px;">
              <h3 style="color: #EAB308; margin: 0 0 15px 0; font-size: 18px;">🎯 Opciones Seleccionadas</h3>
              <table width="100%" cellpadding="8" cellspacing="0">
                <tr style="background-color: #e5e7eb;">
          ...
          <tr>
            <td style="padding: 20px;">
              <p style="color: #92400e; margin: 0; font-size: 14px;">
                📌 <strong>Plan personalizado sin opciones adicionales</strong>
              </p>
              <p style="color: #dc2626; margin: 10px 0 0 0; font-size: 13px;">
                ⚠️ <strong>Transporte NO incluido</strong> - Debes gestionar tu propio transporte
              </p>
            </td>
          </tr>
        </table>
