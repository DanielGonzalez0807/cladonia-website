/**
 * Email al cliente: reserva recibida (confirmación inicial).
 * Incluye info general, visitantes, desglose por plan y total.
 */
import { formatPrice, formatVehicleCounts } from './shared';
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          ${EmailHeader({ title: '¡Reserva Confirmada!', rur, theme: 'dark' })}
