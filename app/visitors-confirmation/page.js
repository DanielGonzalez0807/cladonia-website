      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 flex items-center justify-center px-4 py-20">
        <div className="max-w-2xl w-full bg-gray-800/60 border border-gray-700 rounded-2xl p-8 md:p-12 text-center">
          ...
          <p className="text-gray-300 text-lg mb-8 leading-relaxed">
            Hemos registrado exitosamente la información de todos los visitantes
          </p>

          {rur && (
            <div className="bg-gray-900/60 border border-yellow-400 rounded-xl p-6 mb-8">
              <p className="text-gray-400 text-sm mb-2 uppercase tracking-wider">Código de Reserva</p>
              <p className="text-yellow-400 text-2xl font-bold tracking-wide">{rur}</p>
            </div>
          )}
          ...
          <div className="bg-blue-500/10 border border-blue-400 rounded-xl p-6 mb-8 text-left">
            ...
            <ul className="space-y-3 text-gray-300 text-sm">
              <li className="flex items-start">
                ...
                <span>Nuestro equipo revisará tu información en las próximas <strong>24 horas</strong></span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-400 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Recibirás un correo con las instrucciones de pago y confirmación final</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 text-blue-400 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span>Guarda tu código <strong>{rur}</strong> para cualquier consulta</span>
              </li>
            </ul>
          </div>

          <div className="bg-yellow-400/10 border border-yellow-400 rounded-xl p-5 mb-8">
            <p className="text-yellow-400 text-sm leading-relaxed">
              <strong>Importante:</strong> Revisa tu bandeja de entrada y spam. Si tienes dudas, contáctanos a info@cladonia.org
            </p>
          </div>
...
export default function VisitorsConfirmationPage() {
  return (
    <Suspense fallback={
