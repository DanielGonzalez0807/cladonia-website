...
export default function Header() {
  ...
  return (
    ...
    >
      <nav className="relative mx-auto max-w-au px-2 md:px-8 py-2 md:py-3 flex items-center justify-between bg-black/16 backdrop-blur-md shadow-[0_10px_30px_rgba(0,0,0,0.12)] ">
        {/* Logo */}
        <Link href="/" className="flex flex-row items-center">
          ...
          <Image
            ...
            width={150}
            height={30}
            className="relative object-contain invert md:w-50 md:h-10 mx-1 lg:mx-3 shadow-2xl shadow-black"
          />
        </Link>
