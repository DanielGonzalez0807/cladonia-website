        ...
        <section className="relative w-screen min-h-screen text-gray-900 py-12 md:py-20 bg-white">  
            ...
            <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-6 md:gap-8 lg:gap-32 px-4 md:px-6">
                ...
                <div className="w-full">
                    ...
                    {/* Bento Grid desktop */}
                    <div className="hidden lg:grid grid-cols-5 grid-rows-4 gap-3 h-104">
                        <div className="relative rounded-lg bg-white overflow-hidden row-span-2"></div>
                         <div className="relative rounded-lg overflow-hidden row-span-2 shadow-md shadow-black/50">
                            <Image src="/images/img_1.png" alt="Paisaje natural del Parque Chingaza" fill className="object-cover"/>
                        </div>
                        <div className="relative rounded-lg overflow-hidden col-span-2 shadow-md shadow-black/50">
                            <Image src="/images/img_2.png" alt="Senderos ecológicos en reserva natural" fill className="object-cover"/>
                        </div>
                        <div className="relative rounded-lg bg-white overflow-hidden row-span-1"></div>
                        <div className="relative rounded-lg overflow-hidden row-span-2 shadow-md shadow-black/50">
                            <Image src="/images/img_3.png" alt="Flora y fauna en tour fotográfico" fill className="object-cover"/>
                        </div>
                        <div className="relative rounded-lg overflow-hidden col-span-2 shadow-md shadow-black/50">
