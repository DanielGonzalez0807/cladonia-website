                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        <div className="flex flex-col items-center text-center">
                            <div className="bg-yellow-100 p-4 rounded-full mb-3">
                                <FontAwesomeIcon icon={faPaw} style={{width: '32px', height: '32px'}} className="text-yellow-600" />
                            </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="bg-orange-100 p-4 rounded-full mb-3">
                                <FontAwesomeIcon icon={faDove} style={{width: '32px', height: '32px'}} className="text-orange-400" />
                            </div>
                            <p className="text-sm font-semibold text-gray-900">Chivito de Páramo</p>
                            <p className="text-xs text-gray-600">Ave endémica</p>
                        </div>
                        <div className="flex flex-col items-center text-center">
                            <div className="bg-green-100 p-4 rounded-full mb-3">
                                <FontAwesomeIcon icon={faSeedling} style={{width: '32px', height: '32px'}} className="text-green-600" />
                            </div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-sm font-semibold text-gray-900">Lagunas Naturales</p>
