                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12 max-w-sm md:max-w-none mx-auto">
                    ...
                    <div className="bg-gray-800 p-4 md:p-6 rounded-lg text-center aspect-square flex flex-col justify-center shadow-white shadow-lg">
                        <Image
                            ...
                            className="mx-auto mb-4"
                        />
                        <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Facebook</h3>
                        <p className="text-gray-300 text-sm md:text-base">@CladoniaTurismo</p>
                    </div>
                    <div className="bg-gray-800 p-4 md:p-6 rounded-lg text-center aspect-square flex flex-col justify-center shadow-white shadow-lg">
                        <Image
                            ...
                            className="mx-auto mb-4"
                        />
                        <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4">Instagram</h3>
                        <p className="text-gray-300 text-sm md:text-base">@cladonia_eco</p>
                    </div>
                </div>
            </div>
        </section>                          
